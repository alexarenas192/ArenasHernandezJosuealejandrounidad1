...
<head>
	...
	<title>Cóctel - Página Producto</title>
...
<div class="container-title">Scarlet Desire</div>

<main>
	<div class="container-img">
		<img src="images/coctel1.jpg" alt="Imagen Cóctel">
	</div>
	...
	<div class="container-info-product">
		...
		<div class="section">
			<h4>Ingredientes</h4>
			<ul>
				<li>2 oz de licor base</li>
				<li>1 oz de jugo de limón</li>
				<li>1/2 oz de jarabe natural</li>
		...
		<div class="section">
			<h4>Preparación</h4>
			<p>
				En una coctelera agrega todos los ingredientes junto con hielo.
				Agita vigorosamente por 15 segundos. Sirve en un vaso frío y decora con una rodaja de limón. Disfruta frío.
			</p>
		</div>
		...
		<div class="section">
			...
			<p>
				El cóctel Scarlet Desire nació en los clubes nocturnos de la costa en los años 90, buscando ofrecer una bebida refrescante,
				ligera y elegante. Su nombre proviene de la intensidad roja de sus ingredientes y la pasión que despierta en cada sorbo.
			</p>
		</div>
	</div>
</main>
...
<section class="container-related-products">
	...
	<div class="card-list-products">
		<div class="card">
			<div class="card-img">
				<img src="images/ves1.jpg" alt="Producto 1" />
			</div>
			<div class="info-card">
				<div class="text-product">
					<h3>Cóctel Brillante</h3>
		...
		<div class="card">
			<div class="card-img">
				<img src="images/ves2.jpg" alt="Producto 2" />
			</div>
			<div class="info-card">
				<div class="text-product">
					<h3>Cóctel Atardecer</h3>
					<p>Frutal, suave</p>
				</div>
			</div>
		</div>
		<div class="card">
			<div class="card-img">
				<img src="images/ves3.jpg" alt="Producto 3" />
			</div>
			<div class="info-card">
				<div class="text-product">
					<h3>Cóctel Lunar</h3>
		...
		<div class="card">
			<div class="card-img">
				<img src="images/ves4.jpg" alt="Producto 4" />
			</div>
			<div class="info-card">
				<div class="text-product">
					<h3>Cóctel Fuego</h3>
